<template>
	<view class="content" v-if="show">
		<view class="checkWrap" :style="'width:'+(barWidth+32)+'rpx'">
			<view class="title">
				<view>{{title}}</view>
				<view  @tap="closeHumanCheckHandle">{{closeBtnText}}</view>
			</view>
			<view class="checkBox">
				<view class="checkBar">
					<view class="slide">
						<view :class="'moveBac '+(isAnimation?'animation':'')+(isSuccess?' moveBacSuccess':'')" :style="'width:'+(blockLeft+6)+'rpx;background-color:'+swiperColor"></view>
						<view :class="(isSuccess?'swiperTipsSuccess':'swiperTips')">{{isSuccess?checkSuccessText:actionTips}}</view>
